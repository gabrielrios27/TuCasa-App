import { FLOORSCATEGORIES } from '../../constants/data';
import { categoryTypes } from '../types';

const { SELECT_CATEGORY } = categoryTypes;

const initialState = {
  categories: FLOORSCATEGORIES,
  selected: null,
};

const floorCategoryReducer = (state = initialState, action) => {
  switch (action.type) {
...
export default floorCategoryReducer;
